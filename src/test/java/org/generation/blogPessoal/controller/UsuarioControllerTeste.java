...
public class UsuarioControllerTeste {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<UsuarioModel> requisicao = new HttpEntity<UsuarioModel>(
				new UsuarioModel(0L, "Paulo Antunes", "paulo_antunes@email.com.br", "13465278"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		HttpEntity<UsuarioModel> requisicao = new HttpEntity<UsuarioModel>(
				new UsuarioModel(0L, "Maria da Silva", "maria_silva@email.com.br", "13465278"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<UsuarioModel> usuarioCreate = usuarioService.cadastrarUsuario(
				new UsuarioModel(0L, "Juliana Andrews", "juliana_andrews@email.com.br", "juliana123"));

		UsuarioModel usuarioUpdate = new UsuarioModel(usuarioCreate.get().getId(), "Juliana Andrews Ramos",
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(
				new UsuarioModel(0L, "Sabrina Sanches", "sabrina_sanches@email.com.br", "sabrina123"));

		usuarioService.cadastrarUsuario(
				new UsuarioModel(0L, "Ricardo Marques", "ricardo_marques@email.com.br", "ricardo123"));
